        ...
        <div className="hidden overflow-x-auto w-full custom-scrollbar md:block">
          {incomes.length === 0 ? (
            <div className="relative overflow-hidden p-8 md:p-16 flex flex-col items-center text-center min-h-[400px] justify-center">
              ...
              <button onClick={() => setShowAddModal(true)} className="btn-primary h-13 px-8 rounded-xl font-bold uppercase tracking-wider text-[11px] shadow-xl !bg-emerald-500 hover:!bg-emerald-600 shadow-emerald-500/20 mt-8 flex items-center gap-2">
          ...
          <div className="mobile-dialog-panel glass-card-static w-full max-w-sm p-8 animate-scale-in">
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div className="flex gap-3 w-full mt-2">
                <button onClick={() => { setShowDeleteConfirm(false); setDeletingIncomeId(null); }} className="btn-secondary flex-1 h-12 font-bold rounded-xl">Cancel</button>
                <button onClick={confirmDeleteIncome} className="btn-danger flex-1 h-12 font-bold rounded-xl" disabled={submitting}>Revert</button>
              </div>
            </div>
          </div>
        </div>
