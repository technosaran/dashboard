...
export const metadata: Metadata = {
  title: "Bonds",
  description: "Track your fixed-income securities, coupon payments, and bond portfolio performance.",
};
...
export default async function BondsPage() {
  ...
  return <BondsClient initialData={initialData as unknown as FinanceData} />;
}
