    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>
          This document was automatically generated by the Dashboard. It is for informational purposes only.
        </Text>
      </Page>
    </Document>
  );
  ...
  return (
    <div className="flex items-center">
      <PDFDownloadLink
        ...
        fileName={`Portfolio_Report_${format(new Date(), "MMM_yyyy")}.pdf`}
