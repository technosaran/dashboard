      ...
      <SWRProvider initialData={initialData as unknown as FinanceData}>
        ...
        >
          ...
          <main className="relative flex-1 overflow-y-auto overflow-x-hidden">
            ...
            />
            <div 
              className="relative z-10 w-full overflow-x-hidden px-[var(--page-padding-x)] pb-[calc(var(--mobile-bottom-nav-height)+var(--page-padding-y))] md:pb-[calc(var(--page-padding-y)*2)]"
              style={{
