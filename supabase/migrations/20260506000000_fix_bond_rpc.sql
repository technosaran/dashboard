-- Fix record_bond_purchase RPC: ensure p_maturity_date is NOT NULL
-- to match the bonds table constraint, preventing silent insertion failures.
...
CREATE OR REPLACE FUNCTION record_bond_purchase(
    ...
    p_maturity_date DATE DEFAULT CURRENT_DATE,
