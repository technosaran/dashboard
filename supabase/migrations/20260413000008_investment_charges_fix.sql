-- Migration: Sophisticated Investment v2
-- Purpose: Add p_charges to record_investment for precise auditing.
...
CREATE OR REPLACE FUNCTION record_investment(
    ...
    p_trade_type TEXT,
    p_charges NUMERIC DEFAULT 0 -- Added charges param
) RETURNS JSONB AS $$
DECLARE
...
BEGIN
    ...
    INSERT INTO stock_trades (
        user_id, investment_id, symbol, trade_type, quantity, price, total_amount, charges, trade_date, exchange
    ) VALUES (
        p_user_id, v_investment_id, p_symbol, p_trade_type, p_quantity, p_buy_price, p_total_cost, p_charges, p_date,
