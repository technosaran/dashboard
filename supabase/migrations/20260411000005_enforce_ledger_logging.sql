-- Improved RPC function to ensure EVERYTHING goes to the Ledger
...
DECLARE
    ...
    v_expense_id UUID;
BEGIN
    -- 1. Handle Account-Linked Expense (Balance Deduction)
    ...
    ELSE
        -- 2. Handle Manual Log (No account deduction)
        -- Even without a balance change, we log this as an "Audit Event"
        INSERT INTO ledger_logs (
            user_id, action_type, amount, details
        ) VALUES (
